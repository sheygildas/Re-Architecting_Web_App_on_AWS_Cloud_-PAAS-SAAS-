...
- [Steps to execute the project](#zap-steps-to-execute-the-project)
  ...
  - [Create Elastic Beanstalk Environment](#bulb-create-instances)
  - [Update SG of Backend to Allow traffic from Bean SG](#bulb-create-instances)
  - [Update SG of Backend to Allow Internal Traffic](#bulb-create-instances)
  - [Launch Ec2-Instance for DB Initializing](#bulb-create-instances)
  - [Login to the instance and Initialize RDS DB](#bulb-create-instances)
  - [Change Health Check on Beanstalk at /login](#bulb-create-instances)
  - [Add 443 HTTPS Listener to ELB](#bulb-create-instances)
  - [Build Artifact with Backend Information](#bulb-create-instances)
  - [Deploy Artifact to Beanstalk](#bulb-create-instances)
  - [Create CDN with SSL Certificate](#bulb-create-instances)
  - [Update Entry in DNS Zones](#bulb-create-instances)
